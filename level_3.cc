...
Level_3::Level_3(unsigned int seed): seed{seed}{
	srand(seed);
     counter = 0;
}
Block * Level_3::generateBlock(bool isRandom, std::string file){
     if (isRandom == true) { // if random as been set
          int dropLimit = 1;
          Block * send;
